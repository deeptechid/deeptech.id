  ...
  return (
    <SubsSection>
      <SubscriptionContainer>
        <Content>
          <Heading>
            Gabung ke Newsletter kami untuk update karirmu
          </Heading>
          <Text>
            Kami hanya akan mengirimkan insight berdasarkan pengalaman para pakar teknologi. Gabung sekarang untuk mendapatkan undangan acara yang akan kami laksanakan selanjutnya.
          </Text>
